...
def main():
    ...
    # Reference audio(s)
    ref_audio_path_1 = "assets/BZNSYP_24k/Wave/006673.wav"
    ref_audio_path_2 = "assets/BZNSYP_24k/Wave/007262.wav"

    ref_audio_single = ref_audio_path_1
    ref_audio_batch = [ref_audio_path_1, ref_audio_path_2]

    ref_text_single = "大通道才能支撑物流腾飞。"
    ref_text_batch = [
        "大通道才能支撑物流腾飞。",
        "我想我也不会了。",
    ]
    ...
    # Synthesis targets
    syn_text_single = "你认为这个是好笑的吗？"
    syn_lang_single = "Auto"

    syn_text_batch = [
        "你认为这个是好笑的吗？",
        "其实我真的有发现，你是个好人，但我们不合适。",
    ]
    syn_lang_batch = ["Chinese", "Chinese"]
