...
sf.write("examples/wav/output_custom_voice.wav", wavs[0], sr)
...
sf.write("examples/wav/output_custom_voice_1.wav", wavs[0], sr)
sf.write("examples/wav/output_custom_voice_2.wav", wavs[1], sr)
